...
void main() {
  ...
  testWidgets('create loan has no advance payment controls', (
    WidgetTester tester,
  ) async {
    final ProviderContainer container = await bootContainer();
    ...
    expect(find.text('Advance / prior payment'), findsNothing);
    expect(find.text('Advance amount'), findsNothing);
