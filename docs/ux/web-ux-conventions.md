...
- Cash-loan **timeline** is a mobile passbook ledger (title / meta / signed amount / running Bal), grouped by calendar day, with pending/overpaid as a footer—not a prose sentence list. Share PNG uses the same ledger widgets.
