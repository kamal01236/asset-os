...
8. **[ADR-008: Android packaging](architecture/decisions/ADR-008-android-packaging.md)** — dual web + Android from `apps/web`; Play Store deferred
9. **[Web UX Conventions](ux/web-ux-conventions.md)** — touch-friendly interaction rules, status semantics, and shell contracts
10. **[Phase 5 Extension Stubs](ux/phase5-extension-stubs.md)** — lightweight stubs for voice, templates, and AI suggestions
11. **[Test Suites](engineering/test-suites.md)** — tagged unit/widget/integration suites and dependency → suite map
12. **[Schema Migrations](engineering/schema-migrations.md)** — Drift baseline v24, legacy vs forward upgrades, and migration checklist
